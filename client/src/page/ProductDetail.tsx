...
import { ChevronRight, ShieldCheck, Truck, RotateCcw, Heart, Share2, ShoppingCart } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        ...
        <div className="space-y-4">
          <div className="aspect-square bg-muted/20 rounded-2xl overflow-hidden relative border border-border">
            {product.badge && (
              <Badge className="absolute top-4 left-4 z-10" variant={product.badge === "Sale" ? "destructive" : "default"}>
                {product.badge}
              </Badge>
            )}
            <img 
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <div className="flex flex-col gap-2 flex-1 justify-end">
              <Button size="lg" className="w-full h-12 text-base shadow-lg shadow-primary/20" onClick={handleAddToCart}>
      ...
      <div className="mb-20">
        <Tabs defaultValue="details" className="w-full">
          <TabsList className="w-full justify-start border-b border-border rounded-none bg-transparent p-0 h-auto mb-8">
            <TabsTrigger value="details" className="text-base py-3 px-6 rounded-none border-b-2 border-transparent data-[state=active]:border-violet-500 data-[state=active]:bg-transparent data-[state=active]:shadow-none">
              Product Details
            </TabsTrigger>
            <TabsTrigger value="reviews" className="text-base py-3 px-6 rounded-none border-b-2 border-transparent data-[state=active]:border-violet-500 data-[state=active]:bg-transparent data-[state=active]:shadow-none">
              Reviews ({product.reviewCount})
            </TabsTrigger>
          </TabsList>
          
          <TabsContent value="details" className="prose prose-sm dark:prose-invert max-w-none text-muted-foreground">
              ...
              <div className="md:col-span-1 border border-border p-6 rounded-2xl bg-card">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-sm text-muted-foreground">{product.reviewCount} global ratings</span>
                  </div>
                </div>
                  ...
                  <div key={i} className="pb-6 border-b border-border last:border-0">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">Verified Purchase • 2 months ago</div>
                      </div>
                    </div>
                    <div className="mb-3">
                      <RatingStars rating={5} size={14} />
                    </div>
                    <h4 className="font-semibold text-sm mb-2">Excellent product, highly recommended!</h4>
                    <p className="text-sm text-muted-foreground">
                      This is exactly what I was looking for. The quality is amazing and it arrived much faster than expected. I've been using it every day since I got it.
                    </p>
                  </div>
                ))}
              </div>
      ...
      {relatedProducts.length > 0 && (
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {relatedProducts.length < 4 && dummyProducts.slice(0, 4 - relatedProducts.length).map(p => (
